...
public class OrderManagerController {
	...
	public String updateOrder(@PathVariable long orderId, @PathVariable long itemId,
	...
	public String updateOrder(@PathVariable long orderId, @RequestParam String orderTitle,
			@RequestParam("elementID") List<Integer> elementIds, @RequestParam("element") List<String> elements) {
		logger.info("Updating Order with ID: {}", orderId);
		Map<Long, List<String>> itemsMap = IntStream.range(0, elementIds.size()).boxed()
